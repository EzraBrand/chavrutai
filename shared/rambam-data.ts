...
export const RAMBAM_BOOKS: RambamBook[] = [
  {
    ...
    hilchot: [
      ...
      { displayName: "Human Dispositions", hebrewName: "דעות", chapters: 7, book: "Sefer Madda", sefaria: "Mishneh Torah, Human Dispositions", slug: "Human_Dispositions", alHatorah: "Deot", wikisourceHebrew: "דעות" },
  ...
  },
  {
    ...
    hilchot: [
      { displayName: "Reading the Shema", hebrewName: "קריאת שמע", chapters: 4, book: "Sefer Ahavah", sefaria: "Mishneh Torah, Reading the Shema", slug: "Reading_the_Shema", alHatorah: "Kriat_Shema", wikisourceHebrew: "קריאת_שמע" },
      ...
      { displayName: "Tefillin, Mezuzah and the Torah Scroll", hebrewName: "תפילין מזוזה וספר תורה", chapters: 10, book: "Sefer Ahavah", sefaria: "Mishneh Torah, Tefillin, Mezuzah and the Torah Scroll", slug: "Tefillin_Mezuzah_and_the_Torah_Scroll", alHatorah: "Tefillin_uMezuzah_veSeferTorah", wikisourceHebrew: "תפילין_ומזוזה_וספר_תורה" },
  ...
  },
  {
    ...
    hilchot: [
      ...
      { displayName: "Divorce", hebrewName: "גירושין", chapters: 13, book: "Sefer Nashim", sefaria: "Mishneh Torah, Divorce", slug: "Divorce", alHatorah: "Gerushin", wikisourceHebrew: "גירושין" },
      ...
      { displayName: "Virgin Maiden", hebrewName: "נערה בתולה", chapters: 3, book: "Sefer Nashim", sefaria: "Mishneh Torah, Virgin Maiden", slug: "Virgin_Maiden", alHatorah: "Naara_Betulah", wikisourceHebrew: "נערה_בתולה" },
  ...
  },
  {
    ...
    hilchot: [
      ...
      { displayName: "Forbidden Foods", hebrewName: "מאכלות אסורות", chapters: 17, book: "Sefer Kedushah", sefaria: "Mishneh Torah, Forbidden Foods", slug: "Forbidden_Foods", alHatorah: "Maachalot_Asurot", wikisourceHebrew: "מאכלות_אסורות" },
  ...
  },
  {
    ...
    hilchot: [
      ...
      { displayName: "Appraisals and Devoted Property", hebrewName: "ערכים וחרמין", chapters: 8, book: "Sefer Haflaah", sefaria: "Mishneh Torah, Appraisals and Devoted Property", slug: "Appraisals_and_Devoted_Property", alHatorah: "Arakhin_vaCharamim", wikisourceHebrew: "ערכים_וחרמין" },
    ],
  },
  {
    name: "Sefer Zeraim",
    ...
    hilchot: [
      ...
      { displayName: "Gifts to the Poor", hebrewName: "מתנות עניים", chapters: 10, book: "Sefer Zeraim", sefaria: "Mishneh Torah, Gifts to the Poor", slug: "Gifts_to_the_Poor", alHatorah: "Matanot_Aniyim", wikisourceHebrew: "מתנות_עניים" },
      ...
      { displayName: "Tithes", hebrewName: "מעשרות", chapters: 14, book: "Sefer Zeraim", sefaria: "Mishneh Torah, Tithes", slug: "Tithes", alHatorah: "Maasrot", wikisourceHebrew: "מעשרות" },
      { displayName: "Second Tithes and Fourth Year's Fruit", hebrewName: "מעשר שני", chapters: 11, book: "Sefer Zeraim", sefaria: "Mishneh Torah, Second Tithes and Fourth Year's Fruit", slug: "Second_Tithes_and_Fourth_Years_Fruit", alHatorah: "Maaser_Sheni", wikisourceHebrew: "מעשר_שני_ונטע_רבעי" },
      { displayName: "First Fruits and other Gifts to Priests Outside the Sanctuary", hebrewName: "ביכורים", chapters: 12, book: "Sefer Zeraim", sefaria: "Mishneh Torah, First Fruits and other Gifts to Priests Outside the Sanctuary", slug: "First_Fruits_and_other_Gifts_to_Priests_Outside_the_Sanctuary", alHatorah: "Bikkurim", wikisourceHebrew: "ביכורים_ושאר_מתנות_כהונה_שבגבולין" },
      { displayName: "Sabbatical Year and the Jubilee", hebrewName: "שמיטה ויובל", chapters: 13, book: "Sefer Zeraim", sefaria: "Mishneh Torah, Sabbatical Year and the Jubilee", slug: "Sabbatical_Year_and_the_Jubilee", alHatorah: "Shemitah_veYovel", wikisourceHebrew: "שמיטה_ויובל" },
    ],
  },
  {
    name: "Sefer Avodah",
    ...
    hilchot: [
      ...
      { displayName: "Service on the Day of Atonement", hebrewName: "עבודת יום הכפורים", chapters: 5, book: "Sefer Avodah", sefaria: "Mishneh Torah, Service on the Day of Atonement", slug: "Service_on_the_Day_of_Atonement", alHatorah: "Avodah_Yom_HaKippurim", wikisourceHebrew: "עבודת_יום_הכפורים" },
  ...
  },
  {
    ...
    hilchot: [
      ...
      { displayName: "Offerings for Those with Incomplete Atonement", hebrewName: "מחוסרי כפרה", chapters: 5, book: "Sefer Korbanot", sefaria: "Mishneh Torah, Offerings for Those with Incomplete Atonement", slug: "Offerings_for_Those_with_Incomplete_Atonement", alHatorah: "Mechusrei_Kapparah", wikisourceHebrew: "מחוסרי_כפרה" },
  ...
  },
  {
    ...
    hebrewName: "ספר טהרה",
    hilchot: [
      { displayName: "Defilement by a Corpse", hebrewName: "טומאת מת", chapters: 25, book: "Sefer Taharah", sefaria: "Mishneh Torah, Defilement by a Corpse", slug: "Defilement_by_a_Corpse", alHatorah: "Tumat_Met", wikisourceHebrew: "טומאת_מת" },
      ...
      { displayName: "Immersion Pools", hebrewName: "מקואות", chapters: 11, book: "Sefer Taharah", sefaria: "Mishneh Torah, Immersion Pools", slug: "Immersion_Pools", alHatorah: "Mikvaot", wikisourceHebrew: "מקואות" },
    ],
  },
  {
    name: "Sefer Nezikim",
    ...
    hilchot: [
      ...
      { displayName: "Theft", hebrewName: "גניבה", chapters: 9, book: "Sefer Nezikim", sefaria: "Mishneh Torah, Theft", slug: "Theft", alHatorah: "Genevah", wikisourceHebrew: "גניבה" },
      { displayName: "Robbery and Lost Property", hebrewName: "גזילה ואבידה", chapters: 18, book: "Sefer Nezikim", sefaria: "Mishneh Torah, Robbery and Lost Property", slug: "Robbery_and_Lost_Property", alHatorah: "Gezelah_vaAvedah", wikisourceHebrew: "גזילה_ואבידה" },
      ...
      { displayName: "Murderer and the Preservation of Life", hebrewName: "רוצח ושמירת נפש", chapters: 13, book: "Sefer Nezikim", sefaria: "Mishneh Torah, Murderer and the Preservation of Life", slug: "Murderer_and_the_Preservation_of_Life", alHatorah: "Rotzeach_uShmirat_HaNefesh", wikisourceHebrew: "רוצח_ושמירת_נפש" },
    ],
  },
  {
    name: "Sefer Kinyan",
    hebrewName: "ספר קנין",
    hilchot: [
      { displayName: "Sales", hebrewName: "מכירה", chapters: 30, book: "Sefer Kinyan", sefaria: "Mishneh Torah, Sales", slug: "Sales", alHatorah: "Mechirah", wikisourceHebrew: "מכירה" },
      { displayName: "Ownerless Property and Gifts", hebrewName: "זכייה ומתנה", chapters: 12, book: "Sefer Kinyan", sefaria: "Mishneh Torah, Ownerless Property and Gifts", slug: "Ownerless_Property_and_Gifts", alHatorah: "Zekhiyah_uMattanah", wikisourceHebrew: "זכייה_ומתנה" },
      { displayName: "Neighbors", hebrewName: "שכנים", chapters: 14, book: "Sefer Kinyan", sefaria: "Mishneh Torah, Neighbors", slug: "Neighbors", alHatorah: "Shekhenim", wikisourceHebrew: "שכנים" },
      { displayName: "Agents and Partners", hebrewName: "שלוחין ושותפין", chapters: 10, book: "Sefer Kinyan", sefaria: "Mishneh Torah, Agents and Partners", slug: "Agents_and_Partners", alHatorah: "Sheluhin_veShutafin", wikisourceHebrew: "שלוחין_ושותפין" },
  ...
  },
  {
    ...
    hilchot: [
      { displayName: "Hiring", hebrewName: "שכירות", chapters: 13, book: "Sefer Mishpatim", sefaria: "Mishneh Torah, Hiring", slug: "Hiring", alHatorah: "Skhirut", wikisourceHebrew: "שכירות" },
      { displayName: "Borrowing and Deposit", hebrewName: "שאלה ופיקדון", chapters: 8, book: "Sefer Mishpatim", sefaria: "Mishneh Torah, Borrowing and Deposit", slug: "Borrowing_and_Deposit", alHatorah: "Sheelah_uFikkadon", wikisourceHebrew: "שאלה_ופיקדון" },
      ...
      { displayName: "Plaintiff and Defendant", hebrewName: "טוען ונטען", chapters: 16, book: "Sefer Mishpatim", sefaria: "Mishneh Torah, Plaintiff and Defendant", slug: "Plaintiff_and_Defendant", alHatorah: "Toaen_veNitan", wikisourceHebrew: "טוען_ונטען" },
      { displayName: "Inheritances", hebrewName: "נחלות", chapters: 11, book: "Sefer Mishpatim", sefaria: "Mishneh Torah, Inheritances", slug: "Inheritances", alHatorah: "Nakhalot", wikisourceHebrew: "נחלות" },
    ],
  },
  {
    name: "Sefer Shoftim",
    ...
    hilchot: [
      ...
      { displayName: "Kings and Wars", hebrewName: "מלכים ומלחמות", chapters: 12, book: "Sefer Shoftim", sefaria: "Mishneh Torah, Kings and Wars", slug: "Kings_and_Wars", alHatorah: "Melakhim_uMilchamot", wikisourceHebrew: "מלכים_ומלחמות" },
    ],
  },
];
